...
| 7 | `states:SendTaskSuccess/Failure` on `*` (2FA handler) | Dynamic task tokens | Scope to `arn:aws:states:eu-west-1:123456789012:execution:qitp-prod-*` |
...
| 10 | EventBridge trust: no `aws:SourceAccount` | Low risk in single-account | Add `StringEquals: { "aws:SourceAccount": "123456789012" }` |
