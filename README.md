...
```bash
pip install agent-core --extra-index-url https://${CODEARTIFACT_TOKEN}@platform-835618032093.d.codeartifact.eu-west-1.amazonaws.com/pypi/platform-python/simple/
```
...
| CDK Bootstrap | `cdk bootstrap aws://835618032093/eu-west-1` |
