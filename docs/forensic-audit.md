...
| S-07 | HIGH | No cross-account isolation for dev/staging/prod | All environments in single account `835618032093`. Blast radius of IAM misconfiguration affects production. |
