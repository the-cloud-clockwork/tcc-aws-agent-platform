...
SFN execution IDs have the format:
  arn:aws:states:eu-west-1:123456789012:execution:qitp-dev-weekly-analysis:exec-abc123
...
def sfn_execution_id_to_session_id(execution_id: str) -> str:
    ...
    Examples:
        ...
        ...     "arn:aws:states:eu-west-1:123456789012:execution:qitp-dev-weekly:exec-abc123"
        ... )
        'exec-abc123'
...
class TestSessionBridge:
    ...
    def test_arn_to_session_id(self):
        arn = "arn:aws:states:eu-west-1:123456789012:execution:qitp-dev-weekly:exec-abc123"
    ...
    def test_extract_session_metadata(self):
        execution_input = {
            "_sfn_context": {
                "Execution": {
                    "Id": "arn:aws:states:eu-west-1:123456789012:execution:qitp-dev-weekly:exec-xyz",
                    "StartTime": "2026-03-15T08:30:00Z",
                },
                "StateMachine": {
                    "Id": "arn:aws:states:eu-west-1:123456789012:stateMachine:qitp-dev-weekly",
                },
            },
        }
